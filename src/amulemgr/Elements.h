...
namespace AW {
	...
	constexpr auto StringTypeName = t("SS");
	constexpr auto UInt32TypeName = t("U4");
	constexpr auto Int32TypeName = t("I4");
	constexpr auto Real64TypeName = t("R8");
	constexpr auto TupleTypeName = t("TP");
	constexpr auto MapTypeName = t("MP");
